...
function Homes({ authenticated_account, users, product_single, getAuthenticatedUserAccount, getproductList}) {
...
return (
      ...
      <div className="flex items-center justify-between">
        ...
        {!token ? (
          ...
          <div className="flex gap-[20px]">
            <span className="quicksand font-semibold">Welcome,</span> {users?.userinfo}!<div></div>
    ...
    <div className="row-span-6">
      <div className="grid grid-cols-3 gap-2">
        {Array.isArray(product_single) && product_single.map((categories, index) => (
